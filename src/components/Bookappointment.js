    ...
    script.onload = () => {
      if (window.hbspt) {
        window.hbspt.forms.create({
          region: 'na1',
          portalId: '46242923',
          formId: '23225861-6b3d-405d-95fe-3ddd6c994c8b',
          target: '#hubspotForm'
        });
      }
    };
...
<div className="w-full bg-[#266D81] h-[135px] gap-[100px] p-[75px] flex justify-end text-xl">
    ...
    <main className="bg-orange-100 h-screen ">
      <center><p className="font-extrabold text-5xl text-gray-600 p-[3%]">Please Enter Your Details</p> 
      <div id="hubspotForm" className="w-[35%] p-[5px] absolute top-[40%] left-[33%] ">
    </div>

       {/* <center> <p className="font-extrabold text-5xl text-gray-600 p-[5%]">Please Enter Your Details</p> <form onSubmit={handleSubmit}> 
    ...
    <footer className="bg-black h-[445px] w-[100%] absolute top-[122%] left-0 ">
