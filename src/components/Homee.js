...
export const  Homee = () => 
    ...
    <button  value="guidelines" name="guide"  className="rounded-full bg-orange-500 p-[23px] hover:opacity-70 text-white absolute top-[195%] left-[4%]"><b className="text-2xl">Guidelines</b></button>
    ...
    <button value="shop" name="shopnow" className="rounded-full hover:opacity-70 bg-orange-500 p-[23px] text-white absolute top-[195%] left-[38%]"><b className="text-2xl">book now</b></button>
    ...
    <button value="shop" name="shopnow" className="rounded-full hover:opacity-70 bg-orange-500 p-[23px] text-white absolute top-[195%] left-[74%]"><b className="text-2xl">book now</b></button>
    ...
    <button value="shop now" name="shopbox" className="rounded-full hover:opacity-70 bg-orange-500 p-[23px] text-white absolute top-[70%] left-[45%]"><b className="text-2xl">book now</b></button>
    </div>
</div>
